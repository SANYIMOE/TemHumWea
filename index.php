...
switch ($GET){ //Access information to determine output
    ...
    case 'CRON':
        ...
        if(strtotime($TIME)==strtotime($CRON)){ //If the time is specified
            ...
            file_put_contents($DATAFILE.".txt","\r\n".$DATETIME.' Temperature: '.$DATA['now']['temp'].'˚C; Humidity: '.$DATA['now']['humidity'].'%'.'; Weather: '.$DATA['now']['text'].'; Wind Direction: '.$DATA['now']['windDir'],FILE_APPEND); //Update file
            file_put_contents($DATABASEFILE,json_encode($JSONDATA,JSON_UNESCAPED_UNICODE)); //Encode and write data to database file
        }elseif(strtotime($TIME)==strtotime($CRON2)){ //If the time is specified
            $JSONDATA=array();
            $JSONDATA['now']['updateTime']=$DATETIME;
            $JSONDATA['now']['APIupdateTime']=$DATA['updateTime'];
            $JSONDATA['now']['temp']=$DATA['now']['temp'];
            ...
            $JSONDATA['history']['yesterday']['afternoon']['text']=$DATABASELOAD['history']['yesterday']['afternoon']['text'];
            $JSONDATA['history']['yesterday']['afternoon']['windDir']=$DATABASELOAD['history']['yesterday']['afternoon']['windDir'];
            $JSONDATA['history']['beforeyesterday']['morning']['updateTime']=$JSONDATA['history']['beforeyesterday']['morning']['updateTime'];
            $JSONDATA['history']['beforeyesterday']['morning']['APIupdateTime']=$JSONDATA['history']['beforeyesterday']['morning']['APIupdateTime'];
            $JSONDATA['history']['beforeyesterday']['morning']['temp']=$JSONDATA['history']['beforeyesterday']['morning']['temp'];
            $JSONDATA['history']['beforeyesterday']['morning']['humidity']=$JSONDATA['history']['beforeyesterday']['morning']['humidity'];
            $JSONDATA['history']['beforeyesterday']['morning']['text']=$JSONDATA['history']['beforeyesterday']['morning']['text'];
            $JSONDATA['history']['beforeyesterday']['morning']['windDir']=$JSONDATA['history']['beforeyesterday']['morning']['windDir'];
            $JSONDATA['history']['beforeyesterday']['noon']['updateTime']=$JSONDATA['history']['beforeyesterday']['noon']['updateTime'];
            $JSONDATA['history']['beforeyesterday']['noon']['APIupdateTime']=$JSONDATA['history']['beforeyesterday']['noon']['APIupdateTime'];
            $JSONDATA['history']['beforeyesterday']['noon']['temp']=$JSONDATA['history']['beforeyesterday']['noon']['temp'];
            $JSONDATA['history']['beforeyesterday']['noon']['humidity']=$JSONDATA['history']['beforeyesterday']['noon']['humidity'];
            $JSONDATA['history']['beforeyesterday']['noon']['text']=$JSONDATA['history']['beforeyesterday']['noon']['text'];
            $JSONDATA['history']['beforeyesterday']['noon']['windDir']=$JSONDATA['history']['beforeyesterday']['noon']['windDir'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['updateTime']=$JSONDATA['history']['beforeyesterday']['afternoon']['updateTime'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['APIupdateTime']=$JSONDATA['history']['beforeyesterday']['afternoon']['APIupdateTime'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['temp']=$JSONDATA['history']['beforeyesterday']['afternoon']['temp'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['humidity']=$JSONDATA['history']['beforeyesterday']['afternoon']['humidity'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['text']=$JSONDATA['history']['beforeyesterday']['afternoon']['text'];
            $JSONDATA['history']['beforeyesterday']['afternoon']['windDir']=$JSONDATA['history']['beforeyesterday']['afternoon']['windDir'];
            file_put_contents($DATABASEFILE,json_encode($JSONDATA,JSON_UNESCAPED_UNICODE)); //Encode and write data to database file
        }
    break;
    case 'API':
